...
<head>
  ...
  <title> Log-In - Kishan-Mitra</title>
</head>
...
<body>
  <div id="wrapper" style="background: linear-gradient(90deg, rgba(44,70,82,1) 0%, rgba(171,217,194,1) 77%);">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
              <li>
                <a class="dropdown-item" href="/LogIn/Login.html">Sign In</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <!-- numbers and data by the help of js -->

    <!-- products Discalimer       isko hold pe rkhte  h --> 
