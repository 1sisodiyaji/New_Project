  ...
  <body  style="background: linear-gradient(90deg, rgba(44,70,82,1) 0%, rgba(171,217,194,1) 77%); margin: 0; padding: 0; overflow-x: hidden;">
    ...
    <div id="wrapper">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-dark active" href="/ContactUs.html">Contact us</a>
                  </li>
                </ul>
                <!-- Left links -->
              </div>
        ...
        <div class="container "
            ...
            <div class="conatiner border  border-success  rounded-8 bg-secondary " style=" padding:20px;  height:400px; width:600px; margin:auto">
            ...
            <div class="container text-center text-md-start mt-5">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                  ...
                  <p>
                    Our  Company will help you every possible way as we can by providing digital features like real time market pricing , weather condition in your area  logistic trade and an ecommerce platform for products  and many more...
                  </p>
                </div>
                <!-- Grid column -->
